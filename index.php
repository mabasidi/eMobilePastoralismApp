			...
			var markersData = [
				  {
					  ...
					  address:"{\"address\":\"65 Lamingo Forest\",\"city\":\"Jos East\",\"state\":\"Plateau\",\"zip\":\"06063\"}",
            ...
            title: "We are here"
				   ...
				   google.maps.event.addListener(marker, 'click', function() {
					  ...
					  var iwContent = '<div id="iw_container">' +
                       ...
                       document.getElementById("side-info").innerHTML = "Phone: " + phone + "<br> Address: "+address;
    ...
    <body>
        ...
        <div id="wrapper">
			...
			<div id="mapinfowrapper">
				...
				<div id="info-session">
                    <div class="title">CURRENT LOCATION INFO.</div>
